...
const Hero: NextPage = () => {
  return (
    <div className="w-full h-full relative flex justify-center sm:h-[850px] overflow-hidden text-left text-[40px] sm:text-[60px] text-gray-scales-black font-inter">
      {/* Hero Background */}
